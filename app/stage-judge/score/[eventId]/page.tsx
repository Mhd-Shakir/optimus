...
export default function StageJudgeValuationSheet({ params }: { params: Promise<{ eventId: string }> }) {
    ...
    useEffect(() => {
        ...
        const fetchEventDetails = async () => {
            try {
                ...
                // Extract unique code letters and their marks/assigned topics
    ...
    return (
        <div className="p-6 space-y-6 bg-slate-50 min-h-screen flex flex-col items-center">
            <div className="w-full max-w-4xl space-y-4">
                <button onClick={() => router.push("/stage-judge")} className="text-sm font-bold text-slate-400 hover:text-slate-700 flex items-center gap-1 mb-2">
