...
export default function DemoRegistrations() {
  ...
  const fetchData = async () => {
    try {
      ...
      const mockStudents = [
        { _id: "s1", name: "Ahmed Raza", chestNo: "1024", team: "Ignis", category: "Protons", studentClass: "8", registeredEvents: [{ eventId: "e1", name: "Speech English" }] },
        { _id: "s2", name: "John Doe", chestNo: "2048", team: "Ventus", category: "Nexus", studentClass: "10", registeredEvents: [{ eventId: "e2", name: "Essay Writing" }] }
      ];
  ...
  const handleSetCaptain = async (eventId: string, team: string, groupNo: number, captainStudentId: string) => {
    demoToast("Captain Set", "Simulated setting a captain.");
  };
